...
hl.bind("F9", hl.dsp.global("quickshell:searchToggleRelease"), { description = "Shell: Toggle search" })
hl.bind("F9", hl.dsp.global("quickshell:searchToggleRelease"))
hl.bind("F9", hl.dsp.exec_cmd(qsIsAlive .. " || pkill fuzzel || fuzzel"))
-- hl.bind("F9", hl.dsp.exec_cmd(qsIsAlive .. " || pkill fuzzel || fuzzel"))
...
hl.bind("SUPER + X", hl.dsp.global("quickshell:sidebarLeftToggle"), { description = "Shell: Toggle left sidebar" })
hl.bind("SUPER + ALT + X", hl.dsp.global("quickshell:sidebarLeftToggleDetach"))
...
hl.bind("SUPER + Z", hl.dsp.global("quickshell:mediaModeToggle"), { description = "Shell: Toggle media mode" })
...
hl.bind("SUPER + Right", hl.dsp.exec_cmd(mediaNextCommand), { locked = true, description = "Media: Next track" })
...
hl.bind("SUPER + Left", hl.dsp.exec_cmd("playerctl previous"), { locked = true, description = "Media: Previous track" })
hl.bind(
	"SUPER + Up",
...
--#/# bind = SUPER+SHIFT, Hash,, -- Send and Follow to workspace -- (1, 2, 3,...)
for i = 1, 10 do
...
--#/# bind = Super, F,, -- Next Active Workspace
hl.bind("SUPER + F", hl.dsp.focus({ workspace = "e+1" }))
--#/# bind = Super, S,, -- Previous Active Workspace
hl.bind("SUPER + S", hl.dsp.focus({ workspace = "e-1" }))
--#/# bind = Super, D,, -- Last Active Workspace
hl.bind("SUPER + D", hl.dsp.focus({ workspace = "previous" }))
...
hl.bind(
	"ALT + SHIFT + CTRL + W",
	hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/focus_and_lauch_app.sh wezterm"),
	{ description = "App: WezTerm(T)" }
)
hl.bind(
	"ALT + SHIFT + CTRL + B",
	hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/focus_and_lauch_app.sh browser"),
	{ description = "App: Browser" }
)
hl.bind(
	"ALT + SHIFT + CTRL + D",
	hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/focus_and_lauch_app.sh discord"),
	{ description = "App: Discord" }
)
hl.bind(
	"ALT + SHIFT + CTRL + E",
	hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/focus_and_lauch_app.sh files"),
...
hl.bind("HOME", hl.dsp.exec_cmd("equibop '--toggle-deafen'")) -- # [hidden]
