...
-- Terminal tags
hl.window_rule({ match = { class = "^(org.wezfurlong.wezterm|Alacritty|kitty|kitty-dropterm)$"},            tag = "+terminal" })

-- Terminal workspace tags
hl.window_rule({ match = { class = "^(WezTerm\\(P\\)|WezTerm\\(T\\))$"},                                    tag = "+terminalworkspaces" })
hl.window_rule({ match = { tag = "terminalworkspaces"},                                                     no_blur = true })

-- Spotify tags
hl.window_rule({ match = { class = "^([Ss]potify)$"},                                                       tag = "+spotify" })
...
-- IM tags
hl.window_rule({ match = { class = "^([Dd]iscord|[Ww]ebCord|[Vv]esktop|[Ee]quibop)$"},                      tag = "+im" })
...
hl.window_rule({ match = { class = "^([Mm]pv|vlc|com.stremio.stremio)$"},                                   tag = "+multimedia_video" })
...
-- hl.window_rule({ match = { tag = "terminal"},                                                            workspace = "2" })
hl.window_rule({ match = { tag = "terminalworkspaces"},                                                     workspace = "2" })
...
hl.window_rule({ match = { tag = "games"},                                                                  workspace = "7" })
